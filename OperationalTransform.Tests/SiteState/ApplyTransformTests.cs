...
namespace OperationalTransform.Tests
{
    ...
    public class SiteStateTests
    {
        ...
        {
            var state = "1234";
            var siteState = new DocumentState(1, state);
        ...
        {
            var siteState = new DocumentState(1, "1234");
        ...
        {
            var localSiteState = new DocumentState(1, "12345");
            var remoteSiteState = new DocumentState(2, "12345");
        ...
        {
            var localSiteState = new DocumentState(1, "ABCDE");
            var remoteSiteState = new DocumentState(2, "ABCDE");
